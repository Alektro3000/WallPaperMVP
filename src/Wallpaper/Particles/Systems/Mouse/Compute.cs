...
public class Compute : IDisposable
{
    ...
    public Compute(ID3D12Device device, ParticleBuffers particleSystem, Buffer mouseBuffer, Shared.Global.Buffers commonBuffers, Shared.Field.Buffers fieldBuffers)
    {
        ...
        ParticlePSO = ShaderLibrary.CreatePSO(device, RootSignature, "mouse/compute.hlsl");
        EmitterPSO = ShaderLibrary.CreatePSO(device, RootSignature, "mouse/emitter.hlsl");
        MarkAlivePSO = ShaderLibrary.CreatePSO(device, RootSignature, "mouse/alive.hlsl");
        CopyPSO = ShaderLibrary.CreatePSO(device, RootSignature, "mouse/copy.hlsl");

        DrawCountPSO = ShaderLibrary.CreatePSO(device, RootSignature, "mouse/draw_count.hlsl");
        DrawCountNoCompactPSO = ShaderLibrary.CreatePSO(device, RootSignature, "mouse/draw_count_no_compact.hlsl");


        PrefixLocalPSO = ShaderLibrary.CreatePSO(device, RootSignature, "mouse/prefix_local.hlsl");
        PrefixGlobalPSO = ShaderLibrary.CreatePSO(device, RootSignature, "mouse/prefix_block_sums.hlsl");
        PrefixAddOffsetPSO = ShaderLibrary.CreatePSO(device, RootSignature, "mouse/prefix_add_offset.hlsl");
