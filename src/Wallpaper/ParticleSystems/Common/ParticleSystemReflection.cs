...
public static class ParticleSystemReflection
{
    ...
    public static Dictionary<Type, object> GetParticleSystemSettings()
    {
        ...
        var method = systemType
            ...
            .FirstOrDefault(m =>
            {
                ...
                return parameters.Length == 2 &&
                    parameters[0].ParameterType == typeof(ParticleSystem.InitContext) &&
    ...
    public static IEnumerable<ParticleSystem> CreateParticleSystems(SystemSettings settings, ParticleSystem.InitContext context)
    {
        return GetParticleSystems()
